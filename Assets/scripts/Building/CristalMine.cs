...
public class CristalMine : Mine
{
    ...
    {
        _upgradeCost.metal = Convert.ToInt32(48 * Math.Pow(1.6, _level - 1));
        _upgradeCost.cristal = Convert.ToInt32(24 * Math.Pow(1.6, _level - 1));
    ...
    {
        _productionPerSecond = Convert.ToInt32(20 * _level * Math.Pow(1.1, _level));
    }
}
